...
var Slider = function (_Component) {
  ...
  function Slider(props, context) {
    ...
    _this.changeValue = function (value, target) {
      var onChange = _this.props.onChange;

      if (_this.input) {
        _this.input.value = _this.handleFormat(value);
      }
    ...
    _this.setInputRef = function (input) {
      _this.input = input;
      if (input) {
        input.value = _this.handleFormat(_this.props.value);
      }
    };
    ...
    _this.onInputChange = function (event) {
      ...
      var clamped = (0, _utils.clamp)(rounded, min, max);

      if (!isNaN(value)) {
        if (rounded !== clamped) {
          event.target.value = _this.handleFormat(clamped);
        }
        onChange && onChange(clamped, event.target);
        _this.state.inputIsValid || _this.setState({ inputIsValid: true });
      } else {
        _this.state.inputIsValid && _this.setState({ inputIsValid: false });
      }
    };
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          tooltipWithInput = _props.tooltipWithInput;
      ...
      var showTooltip = tooltipWithInput || tooltip && active;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          showTooltip ? _react2.default.createElement(
            ...
            tooltipWithInput ? _react2.default.createElement('input', { onChange: this.onInputChange, ref: this.setInputRef, maxLength: 4, value: this.handleFormat(value) }) : _react2.default.createElement(
              'span',
              null,
...
Slider.propTypes = {
  ...
  tooltipWithInput: _propTypes2.default.bool,
